...
For more info, visit https://reactjs.org/link/mock-scheduler`);
  ...
  var require_web = __commonJS({
    "../../node_modules/mol_wire_lib/web.js"(exports, module) {
      "use strict";
      ...
      var globalThis = globalThis || (typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : exports);
      var $ = typeof module === "object" ? module["exports"] = globalThis : globalThis;
      $.$$ = $;
      var $node = $node || {};
      ...
      (function($2) {
        ...
        (function($mol_wire_cursor3) {
          $mol_wire_cursor3[$mol_wire_cursor3["stale"] = new class stale extends Number {
            toString() {
              return "\u{1F534}";
            }
          }(-1)] = "stale";
          $mol_wire_cursor3[$mol_wire_cursor3["doubt"] = new class doubt extends Number {
            toString() {
              return "\u{1F7E1}";
            }
          }(-2)] = "doubt";
          $mol_wire_cursor3[$mol_wire_cursor3["fresh"] = new class fresh extends Number {
            toString() {
              return "\u{1F7E2}";
            }
          }(-3)] = "fresh";
          $mol_wire_cursor3[$mol_wire_cursor3["final"] = new class solid extends Number {
            toString() {
              return "\u{1F535}";
            }
          }(-4)] = "final";
      ...
      (function($2) {
        class $mol_wire_pub2 extends Array {
      ...
      (function($2) {
        $2.$mol_wire_auto = null;
        $2.$mol_wire_affected = [];
      })($ || ($ = {}));
      (function($2) {
        $2["devtoolsFormatters"] = $2["devtoolsFormatters"] || [];
        ...
        function $mol_dev_format_auto2(obj) {
          ...
          if (typeof obj === "object" && $2.$mol_dev_format_head in obj) {
            return obj[$2.$mol_dev_format_head]();
          }
          return [
            "object",
            {
        ...
        $2.$mol_dev_format_span = $mol_dev_format_span;
        ...
        $2.$mol_dev_format_accent = $mol_dev_format_span.bind(null, {
          "color": "magenta"
        });
        $2.$mol_dev_format_strong = $mol_dev_format_span.bind(null, {
          "font-weight": "bold"
        });
        $2.$mol_dev_format_string = $mol_dev_format_span.bind(null, {
          "color": "green"
        });
        $2.$mol_dev_format_shade = $mol_dev_format_span.bind(null, {
          "color": "gray"
        });
      ...
      (function($2) {
        class $mol_wire_pub_sub3 extends $mol_wire_pub {
          pub_from = 0;
        ...
        $2.$mol_wire_pub_sub = $mol_wire_pub_sub3;
      })($ || ($ = {}));
      (function($2) {
        $2.$mol_compare_deep_cache = /* @__PURE__ */ new WeakMap();
        function $mol_compare_deep3(left, right) {
        ...
        $2.$mol_compare_deep = $mol_compare_deep3;
        function compare_array(left, right) {
          const len = left.length;
          if (len !== right.length)
            return false;
          for (let i = 0; i < len; ++i) {
            if (!$mol_compare_deep3(left[i], right[i]))
              return false;
          }
          return true;
        }
        ...
        function compare_set(left, right) {
          if (left.size !== right.size)
            return false;
          return compare_iterator(left.values(), right.values(), $mol_compare_deep3);
        }
        function compare_map(left, right) {
          if (left.size !== right.size)
            return false;
          return compare_iterator(left.keys(), right.keys(), Object.is) && compare_iterator(left.values(), right.values(), $mol_compare_deep3);
        }
        function compare_pojo(left, right) {
          ...
          for (let key of left_keys) {
            if (!$mol_compare_deep3(left[key], Reflect.get(right, key)))
              return false;
          }
          return true;
        }
      ...
      (function($2) {
        $2.$mol_key_store = /* @__PURE__ */ new WeakMap();
      ...
      (function($2) {
        $2.$mol_owning_map = /* @__PURE__ */ new WeakMap();
      ...
      (function($2) {
        function $mol_fail_hidden3(error) {
          throw error;
        }
        $2.$mol_fail_hidden = $mol_fail_hidden3;
      })($ || ($ = {}));
      (function($2) {
        class $mol_object22 {
          static $ = $2;
      ...
      (function($2) {
        function $mol_wire_method4(host, field, descr) {
          if (!descr)
        ...
        $2.$mol_wire_method = $mol_wire_method4;
      })($ || ($ = {}));
      (function($2) {
        const handled = /* @__PURE__ */ new WeakSet();
        class $mol_wire_fiber3 extends $mol_wire_pub_sub {
          host;
          task;
          static temp(host, task, ...args) {
            ...
            reuse:
              if (existen) {
                if (!(existen instanceof $mol_wire_fiber3))
                  break reuse;
          ...
          static persist(host, task, ...args) {
            ...
            if (args.length) {
              ...
              if (dict)
                ...
                dict = host[field] = /* @__PURE__ */ new Map();
            } else {
              key = `${host}.${field}`;
          ...
          static plan() {
            ...
            this.plan_task = new $mol_after_frame(() => {
              try {
                ...
                $mol_wire_fiber3.plan_task = null;
              }
            });
          }
          static sync() {
          ...
          plan() {
            $mol_wire_fiber3.planning.push(this);
            $mol_wire_fiber3.plan();
          }
          reap() {
            $mol_wire_fiber3.reaping.push(this);
            $mol_wire_fiber3.plan();
          }
          toString() {
            return this[Symbol.toStringTag];
        ...
        __decorate([
          $mol_wire_method
        ], $mol_wire_fiber3.prototype, "recall", null);
        $2.$mol_wire_fiber = $mol_wire_fiber3;
      })($ || ($ = {}));
      (function($2) {
        ...
        $2.$mol_wire_probe = $mol_wire_probe;
      })($ || ($ = {}));
      (function($2) {
      ...
      (function($2) {
        function $mol_wire_sync2(obj) {
          return new Proxy(obj, {
            get(obj2, field) {
              const val = obj2[field];
              if (typeof val !== "function")
                return val;
              return function $mol_wire_sync3(...args) {
                const fiber = $mol_wire_fiber.temp(obj2, val, ...args);
                return fiber.sync();
              };
            }
          });
        }
        $2.$mol_wire_sync = $mol_wire_sync2;
      })($ || ($ = {}));
      (function($2) {
        function $mol_wire_async2(obj) {
          return new Proxy(obj, {
            get(obj2, field) {
              const val = obj2[field];
              if (typeof val !== "function")
                return val;
              let fiber;
              return function $mol_wire_async3(...args) {
                fiber?.destructor();
                fiber = $mol_wire_fiber.temp(obj2, val, ...args);
                return fiber.async();
              };
            }
          });
        }
        $2.$mol_wire_async = $mol_wire_async2;
      })($ || ($ = {}));
      (function($2) {
        const cacthed = /* @__PURE__ */ new WeakMap();
      ...
      (function($2) {
        $2.$mol_wire_mem = (keys) => (host, field, descr) => {
          if (!descr)
            descr = Reflect.getOwnPropertyDescriptor(host, field);
          const orig = descr?.value ?? host[field];
          const sup = Reflect.getPrototypeOf(host);
      ...
      var $;
      (function($2) {
        function $mol_wire_field2(host, field, descr) {
          if (!descr)
            descr = Reflect.getOwnPropertyDescriptor(host, field);
        ...
        $2.$mol_wire_field = $mol_wire_field2;
      })($ || ($ = {}));
    }
  });
...
`);
  ...
  // ../core/index.ts
  var import_mol_wire_lib3 = __toESM(require_web());

  // ../core/context/context.ts
  var _RemolContext = class {
    constructor(parent) {
      this.parent = parent;
    ...
    clone(cb) {
      const next = new _RemolContext(this);
      if (!cb)
        return next;
      cb(next);
    ...
    set(p, v) {
      var _a2, _b;
      if (v === null)
        throw new Error(`null value not allowed for ${p}`);
      const prev = (_a2 = this.parent) == null ? void 0 : _a2.opt(p);
      if (prev === v)
        return this;
      if (this.registry === void 0) {
        this.registry = ((_b = this.parent) == null ? void 0 : _b.registry) === void 0 ? /* @__PURE__ */ new Map() : new Map(this.parent.registry);
      }
    ...
    get(p) {
      ...
      if (dep === void 0)
        throw new Error(`RemolContext, provide value for ${p}`);
      return dep;
    }
    opt(p) {
      var _a2, _b;
      if (this.registry === void 0 && ((_a2 = this.parent) == null ? void 0 : _a2.registry) !== void 0)
        this.registry = new Map(this.parent.registry);
      const dep = (_b = this.registry) == null ? void 0 : _b.get(p);
      if (dep !== void 0)
        return dep;
      if (isReactContext(p))
  ...
  var RemolContext = _RemolContext;
  RemolContext.instance = new _RemolContext();
  function isReactContext(v) {
    return typeof v === "object" && typeof v.$$typeof === "symbol" && typeof v.Provider === "function";
  }

  // ../core/error/error.ts
  var RemolError = class extends Error {
    static normalize(error) {
      return error instanceof Error ? error : new RemolError(String(error));
    }
    constructor(message, props) {
      super(message);
      this.cause = props == null ? void 0 : props.cause;
    }
  };

  // ../core/wire/wire.ts
  var import_mol_wire_lib = __toESM(require_web());
  var RemolWire = class extends import_mol_wire_lib.$mol_wire_pub_sub {
    constructor(host) {
      super();
      this.host = host;
    }
  ...
  // ../core/wire/object.ts
  var import_mol_wire_lib2 = __toESM(require_web());
  var RemolWirePubSub = class extends import_mol_wire_lib2.$mol_wire_pub_sub {
    constructor() {
      super(...arguments);
      this.cache = void 0;
    }
  };
  var _RemolWireObject = class {
    constructor() {
      this.subs = /* @__PURE__ */ new Map();
    }
    static decorate(decorate, obj) {
    ...
    static mem(obj, index = 0) {
      return this.decorate((0, import_mol_wire_lib2.$mol_wire_mem)(index), obj);
    }
    static action(obj) {
      return this.decorate(import_mol_wire_lib2.$mol_wire_method, obj);
    }
    static props(v) {
      return new Proxy(v, new _RemolWireObject());
    }
    static update(v, next) {
      this.updated = false;
    ...
    set(t, key, value) {
      const sub = this.sub(t, key);
      if (!(0, import_mol_wire_lib2.$mol_compare_deep)(value, sub.cache)) {
        sub.cache = value;
        _RemolWireObject.updated = true;
        sub.emit();
      }
      return true;
    }
  };
  var RemolWireObject = _RemolWireObject;
  RemolWireObject.updated = false;

  // ../core/component/copy.ts
  var hoistBlackList = {
    $$typeof: true,
    render: true,
    compare: true,
  ...
  function remolComponentCopy(base, target) {
  ...
  var RemolContextReact = import_react.default.createContext(RemolContext.instance);
  RemolContextReact.displayName = "RemolReactContext";

  // ../react/fallback.tsx
  var import_react2 = __toESM(require_react());
  function RemolFallback({
    id,
    error,
  ...
  // ../react/remol.tsx
  var _a;
  var _Remol = class extends import_react3.default.Component {
    constructor() {
      super(...arguments);
      ...
      this.registry = void 0;
      this.lastEl = null;
      this.props2 = RemolWireObject.props(this.props);
      this.fiber = new RemolWire(this);
      this.FallbackView = this.fallback.bind(this);
      this.ChildrenView = remolComponentCopy(this.constructor, this.fiber.sync.bind(this.fiber));
    }
    static fc(Origin) {
      var _a2, _b;
      Origin.displayName = (_a2 = Origin.displayName) != null ? _a2 : Origin.name;
      return remolComponentCopy(Origin, (_b = class extends this {
      }, _b.Origin = Origin, _b));
    }
    ...
    static refGet() {
      ...
      return ((_a2 = ctx.registry) != null ? _a2 : ctx.registry = [])[ctx.cursor++];
    }
    static refSet(v) {
    ...
    static action(obj) {
      var _a2;
      return (_a2 = this.refGet()) != null ? _a2 : this.refSet(RemolWireObject.action(obj));
    }
    static mem0(obj, index = 0) {
      var _a2;
      return (_a2 = this.refGet()) != null ? _a2 : this.refSet(RemolWireObject.mem(obj, index));
    }
    static mem1(obj) {
    ...
    toString() {
      var _a2;
      return `${this.constructor.name}${((_a2 = this.props) == null ? void 0 : _a2.id) ? `[${this.props.id}]` : ""}`;
    }
    ...
    componentWillUnmount() {
      ...
      this.lastEl = null;
      this.fiber = void 0;
      this.ChildrenView = void 0;
      this.FallbackView = void 0;
      this.cursor = 0;
      this.registry = void 0;
    }
    fallback(p) {
      return /* @__PURE__ */ import_react3.default.createElement(RemolFallback, {
        children: p.children,
        error: p.error,
    ...
    node() {
      var _a2;
      if ((_a2 = this.state) == null ? void 0 : _a2.error)
        return (0, import_mol_wire_lib3.$mol_fail_hidden)(this.state.error);
      try {
        _Remol.current = this;
        this.cursor = 0;
        this.lastEl = this.sub();
      } catch (orig) {
        if (orig instanceof Promise)
          return (0, import_mol_wire_lib3.$mol_fail_hidden)(orig);
        const error = RemolError.normalize(orig);
        this.state = { error };
        return (0, import_mol_wire_lib3.$mol_fail_hidden)(error);
      }
      return this.lastEl;
    }
    update() {
    ...
    sub() {
      return this.constructor.Origin.call(this, this.props2);
    }
    render() {
      var _a2;
      if ((_a2 = this.state) == null ? void 0 : _a2.error) {
        return this.fallback({
          ...
          resetErrorBoundary: this.state.error ? this.reset.bind(this) : void 0
        });
      }
      return /* @__PURE__ */ import_react3.default.createElement(import_react3.default.Suspense, {
        fallback: /* @__PURE__ */ import_react3.default.createElement(this.FallbackView, {
          children: this.lastEl
        })
      }, /* @__PURE__ */ import_react3.default.createElement(this.ChildrenView, null));
    }
  };
  var Remol = _Remol;
  _a = Symbol.toStringTag;
  Remol.Provider = RemolContextReact.Provider;
  Remol.contextType = RemolContextReact;
  Remol.Origin = void 0;
  Remol.current = void 0;

  // counter/func.tsx
  var import_react4 = __toESM(require_react());
  var RemolDemoCounterFunc = Remol.fc(function RemolDemoCounterFunc2(p) {
    ...
    return /* @__PURE__ */ import_react4.default.createElement("div", {
      id: p.id
    }, /* @__PURE__ */ import_react4.default.createElement("h3", null, "RemolDemoCounterFunc"), value(), /* @__PURE__ */ import_react4.default.createElement("button", {
      id: `${p.id}-add`,
      onClick: () => add()
    }, "Add"));
  });
  ...
  var RemolDemoCounterKlass = class extends Remol {
    value(next) {
      return next != null ? next : 0;
    }
    add() {
    ...
    sub(p = this.props2) {
      return /* @__PURE__ */ import_react6.default.createElement("div", {
        id: p.id
      }, /* @__PURE__ */ import_react6.default.createElement("h3", null, "RemolDemoCounterKlass"), this.value(), /* @__PURE__ */ import_react6.default.createElement("button", {
        id: `${p.id}-add`,
        onClick: () => this.add()
      }, "Add"));
    }
  ...
  __decorateClass([
    (0, import_mol_wire_lib3.$mol_wire_mem)(0)
  ], RemolDemoCounterKlass.prototype, "value", 1);
  __decorateClass([
    import_mol_wire_lib3.$mol_wire_method
  ], RemolDemoCounterKlass.prototype, "add", 1);

  // user/edit.tsx
  var import_react8 = __toESM(require_react());

  // fetch/fetch.ts
  var RemolDemoFetch = class {
    static request(input, init = {}) {
      ...
      return Object.assign(promise, {
        destructor() {
          ctl == null ? void 0 : ctl.abort();
        }
      });
    }
    static response(input, init) {
      const response = (0, import_mol_wire_lib3.$mol_wire_sync)(this).request(input, init);
      if (Math.floor(response.status / 100) === 2)
        return (0, import_mol_wire_lib3.$mol_wire_sync)(response);
      throw new Error(response.statusText || `HTTP Error ${response.status}`);
    }
  };
  __decorateClass([
    import_mol_wire_lib3.$mol_wire_method
  ], RemolDemoFetch, "response", 1);

  // user/store.ts
  var RemolDemoUserStore = class {
    user(id, next) {
      if (next) {
        console.log("saveing user");
        return next;
      }
      return RemolDemoFetch.response(`https://reqres.in/api/users/${id}?delay=1`).json().data;
    }
  };
  __decorateClass([
    (0, import_mol_wire_lib3.$mol_wire_mem)(1)
  ], RemolDemoUserStore.prototype, "user", 1);

  // user/edit.tsx
  var RemolDemoUserEdit = class extends Remol {
    constructor() {
      super(...arguments);
      this.errorCount = 0;
    }
    ...
    userEditableName(next) {
      return next != null ? next : this.userSelected().first_name;
    }
    sub(p = this.props2) {
      ...
      }, /* @__PURE__ */ import_react8.default.createElement("h3", null, "RemolDemoUserEdit"), /* @__PURE__ */ import_react8.default.createElement("button", {
        type: "button",
        onClick: () => this.userNext()
      }, "Load Next"), /* @__PURE__ */ import_react8.default.createElement("p", null, "Click 3 times to generate error"), /* @__PURE__ */ import_react8.default.createElement("div", null, "Original: ", this.userSelected().first_name, " ", this.userSelected().first_name === this.userEditableName() ? "" : " [changed]"), /* @__PURE__ */ import_react8.default.createElement("input", {
        value: this.userEditableName(),
        onChange: (e) => this.userEditableName(e.target.value)
  ...
  __decorateClass([
    (0, import_mol_wire_lib3.$mol_wire_mem)(0)
  ], RemolDemoUserEdit.prototype, "users", 1);
  __decorateClass([
    (0, import_mol_wire_lib3.$mol_wire_mem)(0)
  ], RemolDemoUserEdit.prototype, "userSelectedId", 1);
  __decorateClass([
    (0, import_mol_wire_lib3.$mol_wire_mem)(0)
  ], RemolDemoUserEdit.prototype, "userSelected", 1);
  __decorateClass([
    import_mol_wire_lib3.$mol_wire_method
  ], RemolDemoUserEdit.prototype, "userNext", 1);
  __decorateClass([
    import_mol_wire_lib3.$mol_wire_method
  ], RemolDemoUserEdit.prototype, "userSave", 1);
  __decorateClass([
    (0, import_mol_wire_lib3.$mol_wire_mem)(0)
  ], RemolDemoUserEdit.prototype, "userEditableName", 1);

  // page/page.tsx
  var RemolDemoPage = class extends Remol {
    sub(p = this.props2) {
      ...
      }, /* @__PURE__ */ import_react10.default.createElement(RemolDemoCounterFunc, {
        id: `${p.id}-counter-func`
      }), /* @__PURE__ */ import_react10.default.createElement(RemolDemoCounterKlass, {
        id: `${p.id}-counter-klass`
      }), /* @__PURE__ */ import_react10.default.createElement(RemolDemoUserEdit, {
        id: `${p.id}-user`
      }));
    }
  };
  ...
  // bundle.tsx
  import_react_dom.default.render(/* @__PURE__ */ import_react12.default.createElement(RemolDemoPage, {
    id: "remol-demo-page"
  }), document.getElementById("remol-demo-page"));
})();
/*
object-assign
(c) Sindre Sorhus
